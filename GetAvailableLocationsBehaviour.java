...
public class GetAvailableLocationsBehaviour extends SimpleAchieveREInitiator {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8602278256999812084L;
	
	private ACLMessage request;

	public GetAvailableLocationsBehaviour(UserAgent a) {
	...
	protected void handleInform(ACLMessage inform) {
		try {
			...
			//update the GUI
			((UserAgent)myAgent).gui.updateLocations(results.getItems().iterator());
		}
		catch(Exception e) {
			e.printStackTrace();
		}
